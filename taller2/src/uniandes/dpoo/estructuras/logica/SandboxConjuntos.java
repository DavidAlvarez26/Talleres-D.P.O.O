...
public class SandboxConjuntos
{
    ...
    {
        NavigableSet<String> reversedSet = arbolCadenas.descendingSet();
        return new ArrayList<>(reversedSet);
    }
    ...
    {
        TreeSet<String> invertido = new TreeSet<String>((a, b) -> b.compareTo(a));
