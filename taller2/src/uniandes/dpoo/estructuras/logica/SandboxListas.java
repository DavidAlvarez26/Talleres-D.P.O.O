...
public class SandboxListas {
	 ...
	 *                 de la lista, se inserta el valor en la última posición.
	 */
	 ...
	 *                 lista de enteros, el método no debe hacer nada.
	 */
	...
	public int contarEnterosRepetidos() {
	    ...
	    for (int i = 0; i < listaEnteros.size(); i++) {
	        ...
	        if (apariciones > 0) {
	            count++;
	            listaEnteros.set(i, Integer.MIN_VALUE);
	        }
	    }
