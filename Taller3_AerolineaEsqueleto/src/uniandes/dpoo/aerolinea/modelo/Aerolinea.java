...
public class Aerolinea
{
    ...
    public void programarVuelo( String fecha, String codigoRuta, String nombreAvion ) throws Exception
    {
        ...
        for (Vuelo v : vuelos) {
            if (v.getFecha().equals(fecha) && v.getAvion().equals(avion)) {
                throw new Exception("El avión ya está programado en esa fecha");
            }
        }

        Vuelo nuevo = new Vuelo(fecha, avion, ruta);
        vuelos.add(nuevo);
    }
    ...
    public int venderTiquetes( String identificadorCliente, String fecha, String codigoRuta, int cantidad ) throws VueloSobrevendidoException, Exception
    {
         ...
         if (vuelo == null) {
             throw new Exception("Vuelo no encontrado en la ruta " + codigoRuta + " y fecha " + fecha);
         }
